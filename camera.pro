...
#LIBS += C:\Users\rainbow\Documents\common\opencv-msvc\build\x64\vc15\lib\opencv_world455d.lib

# 디버그 모드이면 opencv_world455d 파일 실행. 릴리즈 모드이면 opencv_world455 파일 실행.
